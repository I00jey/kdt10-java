...
// 예외 발생 시 프로그램의 감작스런 종료를 막고 정상 실행할 수 있도록 처리하는 코드를 예외 처리 코드라고 함
// try-catch-finally 블록으로 처리

// try 블록에서 작성한 코드가 예외없이 정살 실행 -> catch 실행 x, finally 실행 o
...
public class ExceptionEx {
    ...
    public static void main(String[] args) {
        // case 1. 예외 발생 코드
        // System.out.println(divide(8, 0));   // java.lang.ArithmeticException
